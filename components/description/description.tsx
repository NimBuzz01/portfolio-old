...
export default function Description() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-28 max-w-[1100px] text-center leading-8 sm:mb-40 scroll-mt-28"
    ...
    >
      ...
      <div ref={description}>
        <div className="relative flex flex-col items-center gap-12 mt-12 lg:items-start lg:flex-row">
          <p className="gap-2 m-0 text-2xl leading-10 md:text-3xl">
          ...
          <motion.p
            variants={opacity}
            className="w-4/5 m-0 text-lg font-light"
            animate={isInView ? "open" : "closed"}
          >
