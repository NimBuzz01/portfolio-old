  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="#contact"
          className="flex min-w-[11rem] justify-center items-center gap-2 py-3 text-white text-sm sm:text-base transition bg-gray-900 rounded-full outline-none group px-7 focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105"
          onClick={() => {
        ...
        <a
          className="flex min-w-[11rem] justify-center text-sm sm:text-base items-center gap-2 py-3 transition bg-white rounded-full outline-none cursor-pointer group px-7 focus:scale-110 hover:scale-110 active:scale-105 borderBlack dark:bg-white/10"
        ...
        <div className="flex gap-2 items-center justify-center">
          ...
          <a
            className="bg-white justify-center p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
