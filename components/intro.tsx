...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 lg:mt-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]"
    >
      ...
      >
        ...
        experience. I enjoy building sites & apps using Next.js, Typescript,
        Tailwind CSS and Strapi .
      </motion.h1>
