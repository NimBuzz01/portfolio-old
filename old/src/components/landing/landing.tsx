  ...
  return (
    <div className="relative flex h-screen sm:justify-center sm:items-center ">
      ...
      <div className="p-6 sm:flex z-10 sm:flex-col sm:items-center mt-auto mb-10 sm:mt-0 w-full sm:text-center">
        ...
        <motion.p
          className="text-gray-600 sm:text-center text-lg sm:text-xl md:text-2xl w-full leading-tight mt-3 sm:mt-10 sm:max-w-96 md:max-w-[34rem]"
          initial="hidden"
          animate="visible"
      ...
      <div className="w-full z-0 h-full max-w-[800px] max-h-[800px] bg-purple-300 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-3xl"></div>
    </div>
  );
}
